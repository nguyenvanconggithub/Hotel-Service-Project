...
public class AddHotel extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        hotel.setSDT(phone);
        HotelDAO.Instance().addNewHotel(hotel);
        ...
        for(int i = 0;i<arrayIDUltilites.length;i++){
            HotelUltilitiesDAO.Instance().addHotelUtilities(Integer.parseInt(arrayIDUltilites[i]), idHotel);
        ...
        try {
            ...
            for (Part part : req.getParts()) {
                ...
                if (fileName != null && fileName.length() > 0) {
                    ...
                    String linkToSaveInSQL = SAVE_DIRECTORY + File.separator + username + imageNumber + fileName;
                    //Save LinkImage to SQL
                    HotelImageDAO.Instance().addNewHotelImage(linkToSaveInSQL, idHotel);
