        ...
        <div class="container">
            ...
            <form method="POST" class="form" action="add-new-hotel" enctype="multipart/form-data">
                <div class="row form-group">
                    ...
                    <input type="text" name="tenKhachSan" maxlength="30" id="tenKhachSan" class="form-control col-sm-12 col-md-6" required>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <input type="text" name="diaChi" maxlength="45" id="diaChi" class="form-control col-sm-12 col-md-8" required>
                </div>
                <div class="row form-group">
