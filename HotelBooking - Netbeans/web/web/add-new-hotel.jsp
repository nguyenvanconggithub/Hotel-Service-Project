        ...
        <div class="container">
            ...
            <form method="POST" class="form" action="add-new-hotel" enctype="multipart/form-data">
                <div class="row form-group">
                    ...
                    <input type="text" name="tenKhachSan" maxlength="50" id="tenKhachSan" class="form-control col-sm-12 col-md-6" required>
                </div>
                <div class="row form-group">
                    <label for="SDT" class="col-sm-12 col-md-2">SĐT liên hệ</label>
                    <input type="tel" name="SDT" maxlength="11" id="SDT" class="form-control col-sm-12 col-md-4" required>
                </div>
                <div class="row form-group">
                    <label for="tenKhachSan" class="col-sm-12 col-md-2">Địa chỉ</label>
                    <input type="text" name="diaChi" maxlength="150" id="diaChi" class="form-control col-sm-12 col-md-8" required>
                </div>
                <div class="row form-group">
                ...
                <div class="row justify-content-center form-group">
                    ...
                    <span
                        ...
                        <input type="file" name="imageList" class="square-150x150 position-absolute opacity-0"
                               id="preload-inp-add" onchange="addMoreImage(this)" required="">
